...
if(isset($_GET["start_date"]) and isset($_GET["end_date"]))
{
    ...
    JOIN sales ON customers.id = sales.customer_id
    JOIN products on products.id = sales.product_id
    JOIN users ON users.id = sales.user_id WHERE sales.date_sold BETWEEN '$_start' AND $_end
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-sm-12">
             ...
             <form  action="report.php" method="get" class="form-inline mt-2 mb-3">
             ...
             <button class="btn btn-sm btn-primary ml-3">Filter</button>
